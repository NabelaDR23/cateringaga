      ...
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="formreqdana.php"><i class="fa fa-envelope-o"></i> Sent</a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
<form method="POST" action="../controller_gudang/requestdana.php?aksi=dana">
              ...
              <div class="form-group">
                  <label stye="padding-left:50px;" class="form-group">Keperluan :</label>
                    <textarea name="postkeperluan" id="" class="form-control" style="height: 200px">
                    </textarea>
              </div>
              <!-- <div class="form-group">
