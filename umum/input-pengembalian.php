    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="box box-primary">
                ...
                <?php
                    require '../db_umum/mdl_pengembalian.php';
             ...
             <!-- form start -->
                    <form role="form" action="../controller_umum/alatcontroller.php?action=pengembalian" Method="POST">
                <div class="box-body">
                <input type="hidden" name="posttanggalperbaikan" value="<?php echo $fetch['tanggal_perbaikan'] ?>"></input>
