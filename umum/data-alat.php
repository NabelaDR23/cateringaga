        ...
        <div class="box-body" >
           ...
           <table  id="table1" class="display table table-border table-hover">
                ...
                <tr>
                  ...
                  ?>
                  <td>
                    <a class="btn btn-success" href="input-alat-dipinjam.php?postid=<?php echo $fetch['id_alat']; ?>"><i class="fa fa-edit"></i> Tambah sebagai barang di pinjam</a>
                  </td>
                  <?php
                  } else { ?>
                  <td></td>
